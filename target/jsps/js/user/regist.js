$(function() {
	...
	$("#submitBtn").hover(
		...
		function() {
			...
			$("#submitBtn").attr("src", projectName+"/images/regist2.jpg");
		},
		function() {
			$("#submitBtn").attr("src", projectName+"/images/regist1.jpg");
		}
	);
...
function _hyz() {
    ...
    var pathName = window.document.location.pathname;
    var projectName = pathName.substring(0, pathName.substr(1).indexOf('/') + 1);
	$("#imgVerifyCode").attr("src", projectName+"/VerifyCodeCreate?a=" + new Date().getTime());
}
